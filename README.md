...
Заполнить параметры подключения в файле `.env`.
...
5. Записать полученный токен в параметр `TELEGRAM_BOT_TOKEN` файла `.env`.
...
После запуска открыть созданного бота в Telegram и отправить запрос в свободной форме.
